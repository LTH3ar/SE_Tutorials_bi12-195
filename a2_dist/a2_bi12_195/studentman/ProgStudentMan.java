...
import a2_bi12_195.kengine.DocCnt;
import a2_bi12_195.kengine.Engine;
import a2_bi12_195.kengine.Query;
...
public class ProgStudentMan {
    ...
    public Student createStudent(Object[] data) {
        try {
            Student s = new Student((int) data[0], data[1].toString(), (String) data[2], (String) data[3]);
            return s;
        } catch (Exception e) {
            throw new NotPossibleException("studentman.createStudent: cannot create object");
        }
    }
    ...
    public UndergradStudent createUndergradStudent(Object[] data) throws NotPossibleException {
        try {
            UndergradStudent s = new UndergradStudent((int) data[0], data[1].toString(), (String) data[2], (String) data[3]);
            return s;
        } catch (Exception e) {
            throw new NotPossibleException("studentman.createUndergradStudent: cannot create object");
        }
    }
    ...
    public PostgradStudent createPostgradStudent(Object[] data) throws NotPossibleException {
        try {
            PostgradStudent s = new PostgradStudent((int) data[0], data[1].toString(), (String) data[2], (String) data[3], (float) data[4]);
            return s;
        } catch (Exception e) {
            throw new NotPossibleException("studentman.createPostgradStudent: cannot create object");
        }
    }
    ...
    public Query search(String[] words) throws NotPossibleException {
        if (words != null && words.length > 0) {
            try {
                ...
                throw new NotPossibleException("studentman.search: cannot execute query");
            }
        } else {
            throw new NotPossibleException("studentman.search: words is null or empty");
        }
    }
}
